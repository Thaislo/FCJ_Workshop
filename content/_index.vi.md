---
title: "Hồ dữ liệu AWS Serverless"
weight: 1
chapter: false
---

# Hồ dữ liệu AWS Serverless
...
2. [Khám phá và lập danh mục dữ liệu](2-Discovering_cataloging/)
3. [Khám phá dữ liệu](3_exploring_Data/)
4. [Biến đổi dữ liệu](4_transforming_Data)
5. [Làm giàu dữ liệu](5_enriching_Data)
6. [Trực quan hóa dữ liệu](6_visualizing_Data)
7. [Tổng kết](7_summary)
8. [Dọn dẹp](8_clean_Up)